...
const DescriptionPage = () => {
  ...
  useEffect(() => {
    const fetchPodcast = async () => {
      ...
      try {
        ...
        // Check if this podcast is saved in user's library
  ...
  // Check if podcast is saved in user's library
    ...
    <div className="bg-gradient-to-br from-gray-50 to-indigo-50 min-h-screen py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden transform transition-all duration-300 hover:shadow-2xl">
          ...
          <div className="md:flex relative">
            ...
            <div className="md:w-3/5 p-8">
              ...
              <div className="flex flex-wrap gap-4 mt-8">
                <button 
                  className="bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white px-6 py-3 rounded-lg font-medium flex items-center transition-all duration-300 shadow-md hover:shadow-lg"
                ...
                <button 
                  ...
                  } px-6 py-3 rounded-lg font-medium flex items-center transition-all duration-300 shadow-sm hover:shadow`}
                ...
                <button 
                  className="bg-white hover:bg-gray-50 text-gray-800 border border-gray-300 px-6 py-3 rounded-lg font-medium flex items-center transition-all duration-300 shadow-sm hover:shadow"
                  onClick={handleShare}
                >
          ...
          {/* Related podcasts or comments section could be added here */}
        </div>
      </div>
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                ...
                <button 
                  ...
                  className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-indigo-600 text-white px-4 py-1 rounded-md text-sm font-medium hover:bg-indigo-700"
                >
                  Copy
                </button>
              </div>
